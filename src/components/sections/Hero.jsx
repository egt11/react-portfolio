...
const Hero = () => {
    ...
    return (
        <motion.section className='relative' variants={fadeInStagger} initial="hidden" animate="visible" viewport={{once: true, amount: "all"}} id="home">
            <div className="container mx-auto px-4 flex flex-col items-center justify-center min-h-[90dvh] text-center gap-4 md:gap-8 lg:text-left lg:items-start">
